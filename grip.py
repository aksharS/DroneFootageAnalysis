...
class SampleLineFinder:
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_hue = [0.0, 121.93548387096776]
        self.__hsl_threshold_saturation = [0.0, 255.0]
        self.__hsl_threshold_luminance = [0.0, 146.76570458404075]
        ...
        self.__filter_lines_min_length = 162.0
        self.__filter_lines_angle = [0.0, 100.23769100169778]
    ...
    def __find_lines(input):
        ...
        if len(lines) != 0:
            for i in range(1, len(lines[0])):
                tmp = SampleLineFinder.Line(lines[0][i, 0][0], lines[0][i, 0][1],
